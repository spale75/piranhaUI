...
--
-- Table structure for table `asinfo_iana`
--

DROP TABLE IF EXISTS `asinfo_iana`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `asinfo_iana` (
...
/*!50032 DROP TRIGGER IF EXISTS asinfo_iana_before_insert */;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `asinfo_iana_before_insert` BEFORE INSERT ON `asinfo_iana` FOR EACH ROW SET NEW.size = NEW.as_end - NEW.as_begin */;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50032 DROP TRIGGER IF EXISTS asinfo_iana_before_update */;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `asinfo_iana_before_update` BEFORE UPDATE ON `asinfo_iana` FOR EACH ROW SET NEW.size = NEW.as_end - NEW.as_begin */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `asinfo_rdap`
--

DROP TABLE IF EXISTS `asinfo_rdap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `asinfo_rdap` (
  `asn` int(10) NOT NULL,
  `json` text NOT NULL,
...
--
-- Table structure for table `peer_rbuf_1`
--

DROP TABLE IF EXISTS `peer_rbuf_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_rbuf_1` (
...
--
-- Table structure for table `peer_rbuf_2`
--

DROP TABLE IF EXISTS `peer_rbuf_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_rbuf_2` (
  `pos` int(10) unsigned NOT NULL,
  `peerid` int(10) unsigned NOT NULL,
  `timestamp` datetime(3) DEFAULT NULL,
  `msg` char(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `peer_rbuf_3`
--

DROP TABLE IF EXISTS `peer_rbuf_3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_rbuf_3` (
  `pos` int(10) unsigned NOT NULL,
  `peerid` int(10) unsigned NOT NULL,
  `timestamp` datetime(3) DEFAULT NULL,
  `msg` char(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `peer_rbuf_4`
--

DROP TABLE IF EXISTS `peer_rbuf_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_rbuf_4` (
  `pos` int(10) unsigned NOT NULL,
  `peerid` int(10) unsigned NOT NULL,
  `timestamp` datetime(3) DEFAULT NULL,
  `msg` char(1) NOT NULL DEFAULT '1',
...
--
-- Table structure for table `peer_route_1`
--

DROP TABLE IF EXISTS `peer_route_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_route_1` (
  `peerid` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `peer_route_2`
--

DROP TABLE IF EXISTS `peer_route_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_route_2` (
  `peerid` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `peer_route_3`
--

DROP TABLE IF EXISTS `peer_route_3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_route_3` (
  `peerid` int(10) unsigned NOT NULL,
  `networkb` int(10) unsigned NOT NULL,
  `networke` int(10) unsigned DEFAULT NULL,
  `netmask` tinyint(3) unsigned NOT NULL,
...
--
-- Table structure for table `peer_route_4`
--

DROP TABLE IF EXISTS `peer_route_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `peer_route_4` (
  `peerid` int(10) unsigned NOT NULL,
  `networkb1` bigint(20) unsigned NOT NULL,
  `networkb2` bigint(20) unsigned NOT NULL,
  `networke1` bigint(20) unsigned DEFAULT NULL,
